...
fetch("./Template/sidebar.html")
  ...
  .then(data => {
    ...
    if(roleId == 1){
      ...
      ById('surverSetting').remove()
      ById('surverCat').remove()
...
const viewQuestion = (btn)=>{
  ...
  root.querySelector('#heading').innerText = 'Question List for Survey ( '+TName+' )';
  })
}
const viewAnswer = (btn)=>{
  ...
  root.querySelector('#heading').innerText = 'Answer List for Survey ( '+TName+' )';
  })
}
const viewGAnswerReport = (btn)=>{
  ...
  root.querySelector('#heading').innerText = 'Survey Report  ( '+TName+' )';
...
const viewAdminReport = (btn)=>{
  ...
  AdminReports(TId);
  //  root.querySelector('#saveAnsBtn');
  root.querySelector('#heading').innerText = 'Survey Report for ( '+TName+' )';
